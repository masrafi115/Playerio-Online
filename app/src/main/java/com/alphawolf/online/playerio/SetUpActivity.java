...
public class SetUpActivity extends  AppCompatActivity  { 
	...
	private LinearLayout linear_extra_bottom;
	...
	private LinearLayout pick_image;
	private TextView text_pick_image;
	private LinearLayout linear7;
	private TextView text_skip;
	private TextView text_done;
	
	private Intent intent_pick = new Intent();
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		linear_extra_bottom = (LinearLayout) findViewById(R.id.linear_extra_bottom);
		...
		pick_image = (LinearLayout) findViewById(R.id.pick_image);
		text_pick_image = (TextView) findViewById(R.id.text_pick_image);
		...
		m = new RequestNetwork(this);
		network = new RequestNetwork(this);
		
		pick_image.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				intent_pick.setClass(getApplicationContext(), ImagePickActivity.class);
		...
		_user_pic_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (_childKey.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
					_curcle_igm_url(_childValue.get("avatar").toString(), image_pic);
				}
			}
		...
		_m_request_listener = new RequestNetwork.RequestListener() {
			...
			public void onResponse(String _param1, String _param2, HashMap<String, Object> _param3) {
				...
				country = CountryMap.get("name").toString();
			}
		...
		_network_request_listener = new RequestNetwork.RequestListener() {
			...
			public void onResponse(String _param1, String _param2, HashMap<String, Object> _param3) {
				...
				final String _response = _param2;
				final HashMap<String, Object> _responseHeaders = _param3;
				_MusicGarageProgress(false, true, "");
				map = new HashMap<>();
				map.put("username", data.getString("username", ""));
				map.put("email", FirebaseAuth.getInstance().getCurrentUser().getEmail());
				map.put("uid", FirebaseAuth.getInstance().getCurrentUser().getUid());
				map.put(FirebaseAuth.getInstance().getCurrentUser().getUid(), "uid");
				map.put("countryflag", countryFlag);
				map.put("country", country);
				map.put("time", new SimpleDateFormat("HH:mm dd/MM/yyyy").format(cal.getTime()));
				map.put("timezone", new SimpleDateFormat("ZZZZ").format(cal.getTime()));
				map.put("user_color", color);
				profile.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).updateChildren(map);
				map.clear();
				SketchwareUtil.showMessage(getApplicationContext(), "Done Bro!");
			...
			public void onErrorResponse(String _param1, String _param2) {
				...
				final String _message = _param2;
				_MusicGarageProgress(false, true, "");
				if (_message.equals("Unable to resolve host \"www.musicgarage.online\": No address associated with hostname")) {
	...
	private void initializeLogic() {
		...
		_Animation();
		if (data.getString("button", "").equals("")) {
		...
		_user_color();
		_font();
		_setBackground(text_done, 10, 0, "#FFFFFF", true);
		_setBackground(text_skip, 10, 0, "#FFFFFF", true);
		_setBackground(pick_image, 50, 0, "#FFFFFF", true);
		_setBackground(linear_pic, 90, 8, "#FFFFFF", false);
		_TabTarget();
		_setTarget("Upload Profile Picture!", "you can choose your profile pic from your gallery if not simply click on skip button.");
		try {
			var = ((android.telephony.TelephonyManager) SetUpActivity.this.getSystemService(Context.TELEPHONY_SERVICE)).getSimCountryIso().toLowerCase();
		} catch(Exception e) {
			var = "Not Found";
		}
		countryFlag = "https://www.countryflags.io/".concat(var.concat("/flat/64.png"));
		if (!data.getString("username", "").equals("")) {
			text_username.setText(data.getString("username", ""));
		}
		text_skip.setEnabled(false);
		text_done.setEnabled(false);
		m.startRequestNetwork(RequestNetworkController.GET, "https://restcountries.eu/rest/v2/alpha/".concat(var), "country", _m_request_listener);
	}
	...
	public void _font () {
		...
		text_pick_image.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/opensansbold.ttf"), 0);
		text_skip.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/opensansbold.ttf"), 0);
		text_done.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/opensansbold.ttf"), 0);
	...
	public void _Animation () {
		_Animator(linear_header, "translationX", SketchwareUtil.getDip(getApplicationContext(), (int)(600)), 100);
		timer = new TimerTask() {
			@Override
			public void run() {
				runOnUiThread(new Runnable() {
					@Override
					public void run() {
						_Animator(linear_header, "translationX", SketchwareUtil.getDip(getApplicationContext(), (int)(0)), 300);
						timer = new TimerTask() {
							@Override
							public void run() {
								runOnUiThread(new Runnable() {
										...
										timer = new TimerTask() {
											...
											public void run() {
												runOnUiThread(new Runnable() {
													@Override
													public void run() {
														_Animator(linear3, "alpha", 1.0d, 200);
														_Animator(linear_pic, "alpha", 1.0d, 200);
														_Animator(linear5, "alpha", 1.0d, 200);
														_Animator(linear_extra_bottom, "alpha", 1.0d, 200);
														text_skip.setEnabled(true);
	...
	public void _setTarget (final String _title, final String _content) {
		TapTargetView.showFor(SetUpActivity.this,
		
		
		
		TapTarget.forView(findViewById(R.id.image_pic), _title, _content)
		
		                            .outerCircleColorInt(Color.parseColor("#212121"))
		
		                            .outerCircleAlpha(0.99f)
		
		                            .targetCircleColorInt(Color.parseColor("#E0E0E0"))
